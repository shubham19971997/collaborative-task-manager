...
export const updateWorkspaceDetails = async (req: Request, res: Response) => {
  try {
    ...
    const updatedWorkspace = await workspaceService.updateWorkspaceDetails(
      workspaceId,
      body
    );
...
export const deleteWorkspace = async (req: Request, res: Response) => {
  try {
    ...
    const workspaceDetails = await workspaceService.deleteWorkspace(
      workspaceId
    );
...
export const deleteWorkspaceMember = async (req: Request, res: Response) => {
  ...
  const deletedMember = await workspaceService.removeWorkspaceMember(
    workspaceId,
    userId
  );
